...
define('dummy/ember-anchor/tests/modules/ember-anchor/components/ember-anchor.jscs-test', ['exports'], function (exports) {
  module('JSCS - modules/ember-anchor/components');
  test('modules/ember-anchor/components/ember-anchor.js should pass jscs', function () {
    ok(true, 'modules/ember-anchor/components/ember-anchor.js should pass jscs.');
  });
});
define('dummy/ember-anchor/tests/modules/ember-anchor/components/ember-anchor.jshint', ['exports'], function (exports) {
  QUnit.module('JSHint - modules/ember-anchor/components/ember-anchor.js');
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(true, 'modules/ember-anchor/components/ember-anchor.js should pass jshint.');
  });
});
define('dummy/ember-anchor/tests/modules/ember-anchor/mixins/controller-support.jscs-test', ['exports'], function (exports) {
  module('JSCS - modules/ember-anchor/mixins');
  test('modules/ember-anchor/mixins/controller-support.js should pass jscs', function () {
    ok(true, 'modules/ember-anchor/mixins/controller-support.js should pass jscs.');
  });
});
define('dummy/ember-anchor/tests/modules/ember-anchor/mixins/controller-support.jshint', ['exports'], function (exports) {
  QUnit.module('JSHint - modules/ember-anchor/mixins/controller-support.js');
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(true, 'modules/ember-anchor/mixins/controller-support.js should pass jshint.');
  });
});
define('dummy/ember-anchor/tests/modules/ember-anchor/mixins/view-support.jscs-test', ['exports'], function (exports) {
  module('JSCS - modules/ember-anchor/mixins');
  test('modules/ember-anchor/mixins/view-support.js should pass jscs', function () {
    ok(true, 'modules/ember-anchor/mixins/view-support.js should pass jscs.');
  });
});
define('dummy/ember-anchor/tests/modules/ember-anchor/mixins/view-support.jshint', ['exports'], function (exports) {
  QUnit.module('JSHint - modules/ember-anchor/mixins/view-support.js');
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(true, 'modules/ember-anchor/mixins/view-support.js should pass jshint.');
  });
});
...
define('dummy/config/environment', ['ember'], function(Ember) {
  return { 'default': {"modulePrefix":"dummy","environment":"development","baseURL":"/","locationType":"auto","EmberENV":{"FEATURES":{},"RAISE_ON_DEPRECATION":true},"contentSecurityPolicy":{"style-src":"'self' 'unsafe-inline'","img-src":"'self' https://camo.githubusercontent.com","default-src":"'none'","script-src":"'self' 'unsafe-eval'","font-src":"'self'","connect-src":"'self'","media-src":"'self'"},"emberAnchor":{"anchorQueryParam":"anc"},"APP":{"name":"ember-anchor","version":"v0.1.2"},"contentSecurityPolicyHeader":"Content-Security-Policy-Report-Only","exportApplicationGlobal":true}};
});
...
if (!runningTests) {
  require("dummy/app")["default"].create({"name":"ember-anchor","version":"v0.1.2"});
}
